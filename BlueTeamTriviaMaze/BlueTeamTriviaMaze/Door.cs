...
namespace BlueTeamTriviaMaze
{
    public class Door : Image
    {
        ...
        public Door(float x_index, float y_index, Theme theme, TriviaItem triviaItem)
        {
            ...
            //all doors are disabled unless the player is in the room, thus disabled by default
            IsEnabled = false;

            // connect the Click event
            MouseDown += new MouseButtonEventHandler(MazeWindow.GetInstance().GetMaze().GetPlayer().Door_Click);
        }
