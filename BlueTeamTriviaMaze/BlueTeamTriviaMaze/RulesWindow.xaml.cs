    ...
    public partial class RulesWindow : Window
    {
        public RulesWindow()
        {
            ...
            txtblkRules.Text = String.Format("Navigate through the maze by clicking a door in the same room as your character." +
                ...
                " incorrectly the selected door will be locked. Locked doors can only be opened with keys." +
                " The player is given three keys at the begining of the game. The game is lost if you become" +
